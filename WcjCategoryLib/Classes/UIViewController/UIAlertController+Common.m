...
+ (void)ea_showTipStr:(NSString *)tipStr{
    ...
    [[UINavigationController wcj_getCurrentViewController] presentViewController:alertCtrl animated:YES completion:nil];
}
...
- (void)show{
    [[UINavigationController wcj_getCurrentViewController] presentViewController:self animated:YES completion:nil];
}
